...
class GPT(nn.Module):
    ...
    def num_scaling_params(self): return sum(p.numel() for p in self.parameters())
    ...
    def setup_optimizers(self, embedding_lr=0.3, unembedding_lr=0.004, matrix_lr=0.02, adam_betas=(0.8, 0.95), weight_decay=0.0):
